...
- `decide <id> <choice>`: record the choice and set awaiting_operator=false.

Only edit `.claude/operator-ledger.json`. Never touch code, commit, or deploy. Reference no other property or entity.
